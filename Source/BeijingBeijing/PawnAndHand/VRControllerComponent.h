...
class BEIJINGBEIJING_API UVRControllerComponent : public UPrimitiveComponent
{
...
protected:
	...
	void updateHandPosition( FVector &Position );
...
private:
	...
	{
	public:
		FViewExtension( UVRControllerComponent* InMotionControllerComponent ) {
	...
	private:
		friend class UVRControllerComponent;

		/** Motion controller component associated with this view extension */
		UVRControllerComponent* MotionControllerComponent;
